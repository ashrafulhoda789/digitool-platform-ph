...
const Footer = () => {
    return (
        <div>
            <footer className="footer sm:footer-horizontal bg-[#101727]   text-white px-10 py-20">
                <nav>
                    <h1 className='text-3xl font-bold'>DigitTools</h1>
                ...
                <nav>
                    ...
                    <a className="link link-hover">Integrate</a>
                </nav>
                <nav>
